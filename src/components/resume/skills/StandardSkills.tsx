// src/components/resume/skills/StandardSkills.tsx
// This is the detailed skills design we're renaming to "Standard"
...
const StandardSkills: React.FC<SkillsProps> = ({ data }) => {
